...
class UIExportSocketTT(UIExportDevice):
    bl_idname = "VIEW3D_PT_tt_export_socket"
    bl_label = tt_ui_consts['workflow']['export']['ui_name']

    def draw(self, context):
        self.draw_base(context,
                       ot_export_device="tt_operators.export_socket")
