...
class UIMoveConnectorTT(UFitPanel, bpy.types.Panel):
    bl_idname = "VIEW3D_PT_tt_move_connector"
    bl_label = tt_ui_consts['workflow']['align']['ui_name']
    ...
    def draw(self, context):
        ...
        get_standard_navbox(self.layout, "ufit_operators.prev_step", "tt_operators.save_alignment")
