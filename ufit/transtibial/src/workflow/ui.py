...
from .ST_70_push_pull_smooth.UI_push_pull_smooth import UIPushPullRegionsTT, UISmoothRegionsTT
...
def register():
    ...
    bpy.utils.register_class(UISmoothRegionsTT)
...
def unregister():
    ...
    bpy.utils.unregister_class(UISmoothRegionsTT)
