...
from .ST_132_custom_thickness.UI_custom_thickness import UICustomThicknessTF
...
def register():
    ...
    bpy.utils.register_class(UICustomThicknessTF)
...
def unregister():
    ...
    bpy.utils.unregister_class(UICustomThicknessTF)
